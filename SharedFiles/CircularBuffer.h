...
#include "types.h"
//Guy who wrote this
//https://github.com/VincentKO/snoxd-koserver-1/blob/master/shared/CircularBuffer.h
...
class CircularBuffer
{
	...
	__forceinline size_t GetBFreeSpace() { if (m_regionBPointer == nullptr) { return 0; } return (m_regionAPointer - m_regionBPointer - m_regionBSize); }
