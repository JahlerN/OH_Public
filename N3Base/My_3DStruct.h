...
inline __Matrix44 __Matrix44::operator * (const D3DXMATRIX& mtx)
{
	...
	// √÷¿˚»≠ µ» ƒ⁄µÅE.	
	// dino ∏∑¿Ω.. æ∆∑° ƒ⁄µÂ¥¬ 4π¯¬∞ «‡µÈ¿« ∞ËªÅEª ª˝∑´«œø©º≠ ∫Œ¡§»Æ«— ∞ËªÅEª «—¥Ÿ.
	// ∫∏≈ÅE4π¯¬∞ «‡¿Ã (0, 0, 0, 1)¿Œ matrix∏¶ æ≤¡ˆ∏∏ projection matrix¿« ∞ÊøÅE	// (0, 0, 1, 0)¿Œ matrix∏¶ æ≤π«∑Œ ¿ÃªÛ«— ∞·∞˙∏¶ √ ∑°«—¥Ÿ.
...
const DWORD RF_DOUBLESIDED		= 0x4;		// æÁ∏ÅE- D3DCULL_NONE
const DWORD RF_BOARD_Y			= 0x8;		// Y √‡¿∏∑Œ «ÿº≠.. ƒ´∏ﬁ∂Û∏¶ ∫ª¥Ÿ.
const DWORD RF_POINTSAMPLING	= 0x10;		// MipMap ø°º≠.. PointSampling ¿∏∑Œ «—¥Ÿ..
const DWORD RF_WINDY			= 0x20;		// πŸ∂˜ø° ≥Ø∏∞¥Ÿ.. πŸ∂˜¿« ∞™¿∫ CN3Base::s_vWindFactor ∏¶ ¬ÅE∂ «—¥Ÿ..
const DWORD RF_NOTUSELIGHT		= 0x40;		// Light Off
const DWORD RF_DIFFUSEALPHA		= 0x80;		// Diffuse ∞™¿ª ∞Æ∞ÅE≈ı∏˙„œ∞‘ Alpha blending
...
public:
	...
	BOOL	nRenderFlags; // 1-AlphaBlending | 2-æ»∞≥∂ÅE∞ÅEËæ¯¿Ω | 4-Double Side | 8- ??
	DWORD	dwSrcBlend; // º“Ω∫ ∫˙”ªµÅEπÊπ˝
	DWORD	dwDestBlend; // µ•Ω∫∆Æ ∫˙”ªµÅEπÊπ˝
...
const int MAX_MIPMAP_COUNT = 10; // 1024 * 1024 ¥‹∞Ë±˚›ÅEª˝º∫
...
//	By : Ecli666 ( On 2001-09-12 ø¿¿ÅE10:39:01 )
...
//	~(By Ecli666 On 2001-09-12 ø¿¿ÅE10:39:01 )
    ...
    if( fDet < 0.0001f )		// ∞≈¿« 0ø° ∞°±˚€ÅEÅEªÅE¢«ÅE∆Ú∏È∞ÅE¡ˆ≥™∞°¥¬ º±¿Ã ∆Ú«‡«œ¥Ÿ.
        return FALSE;
	...
	// t∞° ≈¨ºˆ∑œ ∏÷∏Æ ¡˜º±∞ÅE∆Ú∏È∞ÅE∏∏≥™¥¬ ¡°¿Ã ∏÷¥Ÿ.
	// t*dir + orig ∏¶ ±∏«œ∏ÅE∏∏≥™¥¬ ¡°¿ª ±∏«“ ºÅE¿÷¥Ÿ.
	// uøÕ v¿« ¿«πÃ¥¬ π´æ˘¿œ±ÅE
	// √ﬂ√ÅE: v0 (0,0), v1(1,0), v2(0,1) <∞˝»£æ»¿∫ (U, V)¡¬«•> ¿Ã∑±Ωƒ¿∏∑Œ æ˚–¿ ¡°ø° ∞°±ı≥™ ≥™≈∏≥Ω ∞Õ ∞∞¿Ω
	//

	if(pVCol) (*pVCol) = vOrig + (vDir * fT);	// ¡¢¡°¿ª ∞ËªÅE.
